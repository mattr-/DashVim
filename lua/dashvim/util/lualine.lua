...
--- Escape a string for use on the statusline
---@param str string
...
--- Format a string for the statusline with an optional highlight group
---@param component table the component being formatted
---@param text string the string being formatted
---@param highlight_group table the highlight group used to format the string
